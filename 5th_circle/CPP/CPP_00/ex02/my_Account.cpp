...
/*   Updated: 2025/09/09 19:49:16 by mkuida           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
bool	Account::makeWithdrawal( int withdrawal )
{
	...
	else
	{
		...
		std::cout << ";withdraw" << withdrawal << ";amount:" << checkAmount() << ";nb_withdrawals:" << this->_nbWithdrawals << std::endl;
		return (true);
	}
}
...
{
	_displayTimestamp();
	std::cout << "index:" << this->_accountIndex << ";amount:" << checkAmount() << ";deposits:" << this->_nbDeposits << ";withdrawls:" << this->_nbWithdrawals << std::endl;
}
