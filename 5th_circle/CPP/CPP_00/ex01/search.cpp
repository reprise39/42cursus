...
static void print_list(Phonebook &phonebook)
{
	...
	for(int i = 1 ; i < BOOK_SIZE ; i++ )
	{
		...
		std::cout << "|" << std::setw(10)  << std::right << phonebook.contact[i].first_name;
		std::cout << "|" << std::setw(10)  << std::right << phonebook.contact[i].last_name;
		std::cout << "|" << std::setw(10)  << std::right << phonebook.contact[i].nickname;
		std::cout << "|" << std::endl;
	}
	std::cout << "   ---------------------------------------------" << std::endl;
}
