...
/*   Updated: 2025/04/06 16:32:35 by mkuida           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static char	*make_fullpath_candidate(char **path_candidate, char *argv, int i);
...
static int	checkcmd_unexist_from_path(char *argv, char *pathtop)
{
	...
	{
		fullpath_candidate = make_fullpath_candidate(path_candidate, argv, i);
